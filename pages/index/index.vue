    ...
    <div id="area-div">
      <div class="md:flex flex-row justify-between md:pt-[51px]">
        <div class="md:w-3/5" :class="[$i18n.locale =='en' ? 'pl-[10px] md:h-[370px]' : 'pl-[36px]']">
          ...
          <div class="text-[#BABABA] leading-[25px] mt-[16px] w-[570px]">One-Stop Infrastructure, Development, Operation and Maintenance Service Platform for Blockchain Projects </div>
          <nuxt-link to="/download" target="_blank">
            <div class="w-[126px] h-11 rounded-[8px] download-btn-shallow"></div>
            <button class="bg-[#FFEDD4] text-base rounded-[8px] px-[24px] py-[10px] flex justify-center items-center text-[#141212] download-btn">
              {{ $t('header.download') }}
            </button>
          </nuxt-link>
        </div>
    ...
    <div id="area-div2" class="flex mt-[160px]">
      <div class="flex-1 mr-[150px] self-center">
        ...
        <span class="text-lg text-[#BABABA]">
          ...
          This charged service provides enterprises endless scalability for their blockchain products’ deployment, development, operation and maintenance.
        </span>
      </div>
